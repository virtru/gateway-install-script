...
# HTTP Proxy Host
# The hostname or IP address of the HTTP proxy server.
#
# Required: No
# Default: None
# Example Values:
...
# HTTPS Proxy Host
# The hostname or IP address of the HTTPS proxy server.
#
# Required: No
# Default: None
# Example Values:
