...
GetGwOutboundRelay() {
 ...
 echo "Gmail Relay"
 echo "GATEWAY_TRANSPORT_MAPS=*=>[smtp-relay.gmail.com]:587"
 echo " "
 echo "Office 365"
 echo "GATEWAY_TRANSPORT_MAPS=*=>[MX Record]:25"
 echo " "
 echo "Custom"
 echo "GATEWAY_TRANSPORT_MAPS=*=>[1.1.1.1]:25"
 echo " "
...
# Example:
# GATEWAY_SMTPD_SASL_ACCOUNTS=example.com=>user1=>password1,example.net=>user2=>password2
# Required: No
#
